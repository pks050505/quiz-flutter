...
class _$_Item implements _Item {
  ...
  @override
  String toString() {
    return 'Item(id: $id, name: $name, obtainded: $obtainded)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _Item &&
            ...
            (identical(other.obtainded, obtainded) ||
                const DeepCollectionEquality()
                    .equals(other.obtainded, obtainded)));
  }
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(obtainded);
